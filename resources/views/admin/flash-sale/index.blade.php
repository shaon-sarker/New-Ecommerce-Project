                            ...
                            <form action="{{ route('admin.flash-sale.update') }}" method="POST">
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        {{-- <input type="text" class="form-control datepicker" name="end_date" vvalue="{{ old('end_date', \Carbon\Carbon::parse($flashSaleDate->end_date ?? now())->format('Y-m-d')) }}"> --}}
                                        <input type="text" class="form-control datepicker" name="end_date"
                                            value="{{ optional($flashSaleDate)->end_date ? \Carbon\Carbon::parse($flashSaleDate->end_date)->format('Y-m-d') : '' }}">
                                    </div>
