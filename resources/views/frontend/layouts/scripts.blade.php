<script>
    $(document).ready(function() {
        ...
        $('.show_product_modal').on('click', function() {
            ...
            $.ajax({
                method: 'GET', // eikhane 'mehtod' spelling error chilo
                url: '{{ route('show-product-modal', ':id') }}'.replace(":id", id),
                beforeSend: function() {
                    $('.product-modal-content').html('<span class="loader"></span>')
                },
                success: function(response) {
                    ...
                    $('.product-modal-content').find('.qty-btn.increment').off('click').on(
                        'click',
                        function() {
                            let input = $(this).closest('.select_number').find(
                                '.number_area');
                    ...
                    $('.product-modal-content').find('.qty-btn.decrement').off('click').on(
                        'click',
                        function() {
                            let input = $(this).closest('.select_number').find(
                                '.number_area');
