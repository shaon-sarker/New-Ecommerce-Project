...
@push('style')
    <style>
        /* Similar Product Card Fix */
#wsus__similar_products .card {
    display: flex;
...
#wsus__similar_products .card img {
    width: 100%;
    height: 200px; /* fixed height */
    object-fit: cover;
}

#wsus__similar_products .card-body {
    padding: 10px;
    flex: 1;
    display: flex;
    flex-direction: column;
...
#wsus__similar_products .card-title {
    font-size: 16px;
    font-weight: 600;
    margin: 5px 0;
}

#wsus__similar_products .card-text {
    font-size: 14px;
    color: #333;
}

#wsus__similar_products .btn {
    margin-top: auto;
    width: 100%;
}
...
<!--============================
        SIMILAR PRODUCTS START
==============================-->
<section id="wsus__similar_products" class="mt-5">
    <div class="container">
        <div class="row">
            <div class="col-12">
