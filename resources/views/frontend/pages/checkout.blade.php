                        ...
                        <div class="wsus__check_form p-3">
                            <form action="{{ route('user.checkout.address.create') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="wsus__check_single_form">
                                            <input type="text" placeholder="Name *" name="name"
                                                value="{{ old('name') }}" style="border: 1px solid #cecaca;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input type="text" placeholder="Phone *" name="phone"
                                                value="{{ old('phone') }}"style="border: 1px solid #cecaca;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input type="email" placeholder="Email *" name="email"
                                                value="{{ old('email') }}"style="border: 1px solid #cecaca;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input type="text" style="border: 1px solid #cecaca;"
                                    ...
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input type="text" placeholder="Town / City *" name="city"
                                                value="{{ old('city') }}" style="border: 1px solid #cecaca;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="wsus__check_single_form">
                                            <input type="text" placeholder="Zip *" name="zip"
                                                value="{{ old('zip') }}" style="border: 1px solid #cecaca;">
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="wsus__check_single_form">
                                            {{-- <input type="text" placeholder="Address *" name="address" value="{{old('address')}}" style="border: 1px solid #cecaca;"> --}}
                                            <textarea cols="3" rows="5" placeholder="Address" name="address" style="border: 1px solid #cecaca;">{{ old('address') }}</textarea>
                                    ...
                                    <div class="col-xl-12 mt-3">
                                        <div class="wsus__check_single_form">
                                            <button type="submit" class="btn" style="background: color:#5d925d">Save
                                                changes</button>
                                        </div>
                                    </div>
                                </div>
